...
export default function YardSignsPage() {
  return (
    <SignProductPage cfg={{
      ...
      selects: [
        {
          label: "Material",
          options: [
            { label: "4mm Corrugated Plastic (Standard)", value: "4mm", priceAdder: 0, description: "Lightweight, weatherproof, great for short-term outdoor use." },
            { label: "6mm Heavy-Duty Coroplast", value: "6mm", priceAdder: 1.5, description: "50% thicker — perfect for long-term yard sign campaigns." },
            { label: "Aluminum (Substrate)", value: "aluminum", priceAdder: 4, description: "Rigid aluminum for permanent outdoor installations." },
          ],
        },
        {
          label: "Printing",
      ...
      toggleGroups: [
        {
          ...
          options: [
            ...
            { id: "15in_stake", label: '15" H-Frame Stakes', priceAdder: 1.49 },
        ...
        },
        {
          ...
          options: [
            ...
            { id: "uv", label: "UV Gloss Coating", priceAdder: 0.75, description: "Adds scratch & fade protection." },
          ],
        },
      ],
      ...
      useCases: ["Political Campaigns", "Real Estate", "Open Houses", "Elections", "Business Promotions", "Events", "Garage Sales", "School Fundraisers"],
      specs: [
      ...
      faqs: [
        { q: "How long will yard signs last outdoors?", a: "Standard 4mm coroplast yard signs typically last 6–12 months outdoors. The 6mm heavy-duty option can last 1–2+ years depending on conditions." },
        { q: "Do your yard signs come with stakes?", a: "Stakes are optional. Select your preferred H-frame wire stake size in the configurator. Step stakes are also available for harder ground." },
        { q: "Can I order just 1 yard sign?", a: "Yes! We have no minimum order quantity. Single signs ship just as fast as bulk orders." },
        { q: "Are the signs waterproof?", a: "Yes. Corrugated plastic is inherently waterproof. Our inks are UV-resistant and won't run or fade in rain." },
      ],
      reviews: [
        { author: "Mike D.", rating: 5, text: "Ordered 200 yard signs for a local election campaign. They arrived the next day and looked exactly like the proof!" },
        { author: "Sandra R.", rating: 5, text: "Used for our open house. Very professional look, easy to stake in the ground. Will definitely order again." },
        { author: "Tom B.", rating: 4, text: "Great quality for the price. Colors were vibrant and matched perfectly." },
      ],
