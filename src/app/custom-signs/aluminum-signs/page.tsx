...
export default function AluminumSignsPage() {
  return (
    <SignProductPage cfg={{
      ...
      selects: [
        {
          ...
          options: [
            { label: ".040 Aluminum (Standard)", value: "040", priceAdder: 0, description: "Standard gauge — great for most applications." },
            { label: ".080 Aluminum (Heavy Duty)", value: "080", priceAdder: 5.5, description: "Double thickness for maximum rigidity." },
          ],
        },
        {
          label: "Finish",
          options: [
            { label: "Matte White (Standard)", value: "matte", priceAdder: 0 },
            { label: "High Gloss", value: "gloss", priceAdder: 2.5 },
            { label: "Reflective (ASTM D4956)", value: "reflective", priceAdder: 8, description: "Highly visible at night — for safety & regulatory use." },
          ],
        },
        {
          label: "Printing",
      ...
      toggleGroups: [
        {
          ...
          options: [
            ...
            { id: "custom_holes", label: "Custom Hole Placement", priceAdder: 1 },
      ...
      useCases: ["Business Signs", "Parking Signs", "Street Signs", "Safety Signs", "Property Signs", "Regulatory Signs", "Directional Signs"],
      specs: [
      ...
      faqs: [
        { q: "How long do aluminum signs last?", a: "Our aluminum signs are rated for 7–10+ years outdoors. The UV-resistant inks won't fade, and aluminum won't rust or corrode." },
        { q: "Can I get reflective aluminum signs?", a: "Yes! Select the 'Reflective' finish option. Our reflective signs meet ASTM D4956 standards and are great for regulatory, safety, and parking applications." },
        { q: "Are mounting holes included?", a: "Mounting holes are optional. Choose corner holes (standard 5/16\") or custom placement in the configurator — always free to add." },
        { q: "Do you offer custom shapes?", a: "Standard shapes (square/rectangle with optional rounded corners) are available online. Contact us for completely custom cut shapes." },
      ],
      reviews: [
        { author: "Frank L.", rating: 5, text: "We've had these parking signs up for 3 years and they still look brand new. Incredible durability." },
        { author: "Donna S.", rating: 5, text: "Ordered 50 directional signs for our campus. Fast turnaround, perfect print quality." },
        { author: "Brian T.", rating: 5, text: "The reflective signs are exactly what we needed for night visibility. Very professional." },
      ],
      ctaHeading: "Signs That Last a Decade",
      ctaBody: "Rust-proof aluminum signs printed with UV inks that resist fading for years.",
