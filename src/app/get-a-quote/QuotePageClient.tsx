            ...
            <div className="space-y-8">
              ...
              <div className="border-b border-slate-100 pb-6">
                ...
                <h1 className="text-3xl md:text-4xl font-black font-poppins text-slate-800 leading-tight">
                  Get a Custom Signage &amp; Print Quote
                </h1>
                <p className="text-sm text-slate-500 font-medium leading-relaxed mt-2 font-opensans max-w-3xl">
                  Need premium custom signs, LED signs, banners, business cards, or other marketing materials? Specify your dimensions and upload your artwork files below. Our print specialists will email you a layout proof and pricing quote within 12 hours.
                </p>
