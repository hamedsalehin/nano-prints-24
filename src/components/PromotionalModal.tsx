    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-y-auto">
          ...
          {/* Modal Container */}
          <div
            className="relative w-full max-w-3xl bg-[#030303] text-white rounded-2xl overflow-hidden border border-slate-800/80 shadow-2xl z-10 animate-in zoom-in-95 duration-300 flex flex-col md:flex-row"
            style={{
          ...
          >
            ...
            <button
              onClick={handleClose}
              className="absolute top-4 right-4 z-20 p-2 text-slate-400 hover:text-white rounded-full bg-black/40 hover:bg-white/10 transition-colors"
            ...
            <div className="md:w-5/12 bg-gradient-to-br from-[#0d0714] via-[#050b16] to-[#040404] p-8 md:p-10 border-b md:border-b-0 md:border-r border-slate-800/60 flex flex-col justify-between relative overflow-hidden">
              {/* Background glows */}
              ...
              <div className="relative space-y-6">
                ...
                <div className="space-y-2 pt-4">
                  ...
                  <h3 className="text-4xl md:text-5xl font-black font-poppins tracking-tight leading-none">
                  ...
                  <p className="text-xs text-slate-400 font-semibold tracking-wide uppercase pt-1">
                    On your first order
                  </p>
                </div>
              </div>

              <div className="relative pt-8 space-y-3.5 text-xs text-slate-300 font-medium">
            ...
            <div className="md:w-7/12 p-8 md:p-10 flex flex-col justify-center bg-[#070709] relative">
              {!success ? (
                /* EMAIL CAPTURE STATE */
                <div className="space-y-6">
                  ...
                  <form onSubmit={handleClaim} className="space-y-4">
                    {error && (
                      <div className="p-3.5 bg-red-950/40 border border-red-800/40 rounded-xl flex gap-2.5 text-xs text-red-200">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-12 pr-4 py-3.5 bg-[#121216] border border-slate-800 rounded-xl text-sm text-white placeholder-slate-500 focus:outline-none focus:border-[#00e5ff] focus:ring-1 focus:ring-[#00e5ff] transition-all"
                      />
                    </div>
                    ...
                    <button
                      type="submit"
                      disabled={loading}
                      className="w-full active:scale-[0.99] text-white font-bold py-3.5 rounded-xl transition-all text-sm uppercase tracking-wider brand-gradient shadow-lg flex items-center justify-center gap-2 hover:opacity-90 disabled:opacity-50"
                      style={{
                ...
                <div className="space-y-6 text-center md:text-left">
                  <div className="flex flex-col md:flex-row items-center gap-4">
                    <div className="w-12 h-12 bg-green-950/50 text-green-400 border border-green-800/50 rounded-full flex items-center justify-center shadow-lg shadow-green-950/30 shrink-0">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-[#00e5ff] font-bold uppercase tracking-wider mt-0.5">
                        Your 10% Discount is Active
                      </p>
                    </div>
                  </div>

                  <div className="p-4 bg-[#121216] border border-slate-800 rounded-xl space-y-2 text-sm text-slate-300 text-left">
                    ...
                    <p className="leading-relaxed text-slate-400 text-xs mt-1">
                  ...
                  <button
                    onClick={handleClose}
                    className="w-full bg-[#1e1e24] hover:bg-[#2a2a32] text-white font-bold py-3 rounded-xl transition-all text-xs uppercase tracking-wider"
                  >
                    Start Shopping
                  </button>
                </div>
              ...
              <div className="mt-8 pt-5 border-t border-slate-800/60 relative">
